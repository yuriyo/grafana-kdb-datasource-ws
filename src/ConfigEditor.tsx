      ...
      <div className="gf-form-group">
        ...
        <div className="gf-form-group">
          {this.state.authChecked && !this.state.tlsChecked && (
            <Alert title={'Connection Insecure'} severity={'error'}>
              <br />
              <p>
                Connecting over authorised WebSockets without TLS enabled will transmit all information including
                <strong style={{ color: 'red' }}> username-password pairs in clear text</strong>. We{' '}
                <strong>highly</strong> recommend if using authorisation that TLS is enabled. The KDB+ server is also
                required to have TLS enabled for secure WebSockets to connect.
                <p>
                  See the{' '}
                  <a className="external-link" target="_blank" href="https://code.kx.com/q/kb/ssl/" rel="noreferrer">
                    kx wiki SSL/TLS page
                  </a>{' '}
          ...
          {this.state.authChecked && this.state.tlsChecked && (
            <Alert title={'TLS Enabled'} severity={'success'}>
              <br />
              <p>
                ...
                <a
                  ...
                  target="_blank"
                  href="https://it.nmu.edu/docs/adding-security-exception-your-browser"
                  rel="noreferrer"
                >
                  is provided here.
                </a>
